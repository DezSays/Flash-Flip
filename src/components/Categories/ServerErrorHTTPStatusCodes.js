...
const ServerErrorHTTPStatusCodes = () => {
  ...
  const getData = async () => {
    ...
    const lvl1 = data.server_error_http_status_codes.level[0].one[`${idx1}`];
    ...
    const lvl2 = data.server_error_http_status_codes.level[1].two[`${idx2}`];
    ...
    let idx3 = getRandomInt(0, 2);

    const lvl3 = data.server_error_http_status_codes.level[2].three[`${idx3}`];
    ...
    const lvl4 = data.server_error_http_status_codes.level[3].four[`${idx4}`];
    ...
    const lvl5 = data.server_error_http_status_codes.level[4].five[`${idx5}`];
...
export default ServerErrorHTTPStatusCodes;
