...
const JavaScriptStringMethods = () => {
  ...
  const getData = async () => {
    ...
    const lvl1 = data.javascript_string_methods.level[0].one[`${idx1}`];
    ...
    let idx2 = getRandomInt(0, 8);

    const lvl2 = data.javascript_string_methods.level[1].two[`${idx2}`];
    ...
    let idx3 = getRandomInt(0, 4);

    const lvl3 = data.javascript_string_methods.level[2].three[`${idx3}`];
    ...
    const lvl4 = data.javascript_string_methods.level[3].four[`${idx4}`];
    ...
    let idx5 = getRandomInt(0, 4);

    const lvl5 = data.javascript_string_methods.level[4].five[`${idx5}`];
  ...
  if (display === 0) {
    return (
      <>
        <Stack gap={2}>
          <button id="category-title">JavaScript String Methods</button>
          <button
