...
const RedirectionHTTPStatusCodes = () => {
  ...
  const getData = async () => {
    ...
    const lvl1 = data.redirection_http_status_codes.level[0].one[`${idx1}`];
    ...
    const lvl2 = data.redirection_http_status_codes.level[1].two[0];
    ...
    const lvl3 = data.redirection_http_status_codes.level[2].three[`${idx3}`];
    ...
    const lvl4 = data.redirection_http_status_codes.level[3].four[0];
    ...
    const lvl5 = data.redirection_http_status_codes.level[4].five[`${idx5}`];
...
export default RedirectionHTTPStatusCodes;
