...
const SortingAlgorithms = () => {
  ...
  const getData = async () => {
    ...
    const lvl1 = data.sorting_algorithms.level[0].one[0];
    ...
    const lvl2 = data.sorting_algorithms.level[1].two[0];
    ...
    const lvl3 = data.sorting_algorithms.level[2].three[`${idx3}`];
    ...
    const lvl4 = data.sorting_algorithms.level[3].four[`${idx4}`];
    ...
    const lvl5 = data.sorting_algorithms.level[4].five[`${idx5}`];
  ...
  if (display === 0) {
    return (
      <>
        <Stack gap={2}>
          <button id="category-title">Sorting Algorithms</button>
          <button
