...
const PythonErrorTypes = () => {
  ...
  const getData = async () => {
    ...
    let idx1 = getRandomInt(0, 4);

    const lvl1 = data.python_error_types.level[0].one[`${idx1}`];
    ...
    let idx2 = getRandomInt(0, 5);

    const lvl2 = data.python_error_types.level[1].two[`${idx2}`];
    ...
    const lvl3 = data.python_error_types.level[2].three[`${idx3}`];
    ...
    let idx4 = getRandomInt(0, 6);

    const lvl4 = data.python_error_types.level[3].four[`${idx4}`];
    ...
    const lvl5 = data.python_error_types.level[4].five[`${idx5}`];
...
export default PythonErrorTypes;
