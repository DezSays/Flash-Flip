...
const VanillaJavaScript = () => {
  ...
  const getData = async () => {
    ...
    let idx1 = getRandomInt(0, 12);

    const lvl1 = data.vanilla_javascript.level[0].one[`${idx1}`];
    ...
    let idx2 = getRandomInt(0, 17);

    const lvl2 = data.vanilla_javascript.level[1].two[`${idx2}`];
    ...
    let idx3 = getRandomInt(0, 55);

    const lvl3 = data.vanilla_javascript.level[2].three[`${idx3}`];
    ...
    let idx4 = getRandomInt(0, 23);

    const lvl4 = data.vanilla_javascript.level[3].four[`${idx4}`];
    ...
    let idx5 = getRandomInt(0, 9);

    const lvl5 = data.vanilla_javascript.level[4].five[`${idx5}`];
  ...
  if (display === 0) {
    return (
      <>
        <Stack gap={2}>
          <button id="category-title">Vanilla JavaScript</button>
          <button
