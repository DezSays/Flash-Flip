...
const CSS = () => {
  ...
  const getData = async () => {
    ...
    let idx1 = getRandomInt(0, 21);

    const lvl1 = data.css.level[0].one[`${idx1}`];
    ...
    let idx2 = getRandomInt(0, 69);

    const lvl2 = data.css.level[1].two[`${idx2}`];
    ...
    let idx3 = getRandomInt(0, 90);

    const lvl3 = data.css.level[2].three[`${idx3}`];
    ...
    let idx4 = getRandomInt(0, 109);

    const lvl4 = data.css.level[3].four[`${idx4}`];
    ...
    let idx5 = getRandomInt(0, 43);

    const lvl5 = data.css.level[4].five[`${idx5}`];
  ...
  if (display === 0) {
    return (
      <>
        <Stack gap={2}>
          <button id="category-title">CSS</button>
          <button
